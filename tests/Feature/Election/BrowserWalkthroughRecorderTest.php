...
test('voter ballot includes position and candidate navigation aids', function (): void {
    ...
    expect($positionNavigation)->toContain('Jump to position')
        ...
        ->and($voterBallot)->toContain('formattedElapsed')
        ->and($voterBallot)->toContain('transformSubmission')
        ->and($voterBallot)->toContain('selection_edit_count')
        ->and($voterBallot)->toContain('Fill remaining choices')
        ->and($voterBallot)->toContain('random_fill_used')
        ->and($voterBallot)->toContain('Ballot package needs refresh')
