        ...
        <header class="border-b border-stone-300 bg-white">
            <div class="mx-auto max-w-6xl px-5 py-8 sm:px-8">
                ...
                <p class="mt-3 max-w-3xl text-stone-700">
                    Choose a precinct to participate as a voter, Election
                    Officer, or observer. Candidate totals remain sealed until
                    that precinct closes.
                </p>
            </div>
        </header>
        <section
