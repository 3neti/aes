...
{
    protected $signature = 'election:scenario {scenario : legal-suite, supply-verification-baseline, initialization-report, open-polls-initialization-report, fts-manual-verification-discrepancy, fts-zero-out, voting-legal-edge-cases, special-polling-intake, close-polls-and-counting-legal-evidence, election-return-legal-artifact, election-return-copy-distribution, delivery-package, delivery-receipt, manual-handoff, final-backup, custody-turnover, audit-reconciliation-baseline, friday-certification, full-demo, evidence-folder-demo, field-50-ballots, pop-import-demo, or eb-role-baseline}';
