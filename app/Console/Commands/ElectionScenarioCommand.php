...
{
    protected $signature = 'election:scenario {scenario : legal-suite, supply-verification-baseline, friday-certification, full-demo, evidence-folder-demo, pop-import-demo, or eb-role-baseline}';
