...
final class EvidenceReferenceBaselineService
{
    ...
    private function collectReferences(string $runPath, string $precinct): array
    {
        $paths = [
            ...
            ['reference_type' => 'active_precinct_config', 'relative_path' => '01-precinct-package-and-configuration/active-precinct.json', 'required' => true],
            ['reference_type' => 'active_package', 'relative_path' => '01-precinct-package-and-configuration/active-package.json', 'required' => true],
            ['reference_type' => 'device_certification_report', 'relative_path' => '02-final-testing-and-sealing/device-certification-report.json', 'required' => true],
            ['reference_type' => 'attestation_manifest', 'relative_path' => '03-opening-of-polls/attestations', 'required' => false],
            ['reference_type' => 'signature_manifest', 'relative_path' => '03-opening-of-polls/signatures', 'required' => false],
            ...
            ['reference_type' => 'transmission_report', 'relative_path' => '08-transmission-or-official-handoff/transmission-report.json', 'required' => false],
            ['reference_type' => 'final_backup_report', 'relative_path' => '09-final-backup/final-backup-report.json', 'required' => false],
            ['reference_type' => 'custody_record', 'relative_path' => '10-custody-turnover/custody-record.json', 'required' => false],
            ['reference_type' => 'evidence_manifest', 'relative_path' => '12-audit-and-reconciliation/evidence-manifest.json', 'required' => false],
            ['reference_type' => 'evidence_bundle_archive', 'relative_path' => '12-audit-and-reconciliation/evidence-bundle-archive.json', 'required' => false],
            ['reference_type' => 'scenario_report', 'relative_path' => '00-start-here', 'required' => false],
            ['reference_type' => 'jurisdiction_journal', 'relative_path' => '13-journal', 'required' => false],
        ];
