...
final class ElectionStorage
{
    ...
    private function runRelativePath(string $relative): string
    {
        ...
        return match (true) {
            ...
            $relative === 'print-forms/tally-sheet' => self::CeremonyDirectories['counting'].'/print-forms/tally-sheet',
            str_starts_with($relative, 'print-forms/tally-sheet/') => self::CeremonyDirectories['counting'].'/print-forms/tally-sheet/'.substr($relative, strlen('print-forms/tally-sheet/')),
            $relative === 'print-forms/ballots' => self::CeremonyDirectories['voting'].'/print-forms/ballots',
            str_starts_with($relative, 'print-forms/ballots/') => self::CeremonyDirectories['voting'].'/print-forms/ballots/'.substr($relative, strlen('print-forms/ballots/')),
            $relative === 'print-forms/control-number' => self::CeremonyDirectories['voting'].'/print-forms/control-number',
            str_starts_with($relative, 'print-forms/control-number/') => self::CeremonyDirectories['voting'].'/print-forms/control-number/'.substr($relative, strlen('print-forms/control-number/')),
            $relative === 'print-forms/election-return' => self::CeremonyDirectories['returns'].'/print-forms',
            str_starts_with($relative, 'print-forms/election-return/') => self::CeremonyDirectories['returns'].'/print-forms/'.substr($relative, strlen('print-forms/election-return/')),
            ...
            $relative === 'voter-authorizations' => self::CeremonyDirectories['voting'].'/voter-authorizations',
            str_starts_with($relative, 'voter-authorizations/') => self::CeremonyDirectories['voting'].'/voter-authorizations/'.$basename,
            $relative === 'admission-queue' => self::CeremonyDirectories['voting'].'/admission-queue',
            str_starts_with($relative, 'admission-queue/') => self::CeremonyDirectories['voting'].'/admission-queue/'.$basename,
            $relative === 'admission-intake.json' => self::CeremonyDirectories['voting'].'/admission-intake.json',
            $relative === 'contention-reports' => self::CeremonyDirectories['voting'].'/contention-reports',
            ...
            $relative === 'print-jobs/control-number' => self::CeremonyDirectories['voting'].'/print-jobs/control-number',
            str_starts_with($relative, 'print-jobs/control-number/') => self::CeremonyDirectories['voting'].'/print-jobs/control-number/'.substr($relative, strlen('print-jobs/control-number/')),
            ...
            $relative === 'device-tabulation-ledger' => self::CeremonyDirectories['voting'].'/device-tabulation-vvdat-ledger',
            str_starts_with($relative, 'device-tabulation-ledger/') => self::CeremonyDirectories['voting'].'/device-tabulation-vvdat-ledger/'.$basename,
            $relative === 'closing' => self::CeremonyDirectories['closing'],
            str_starts_with($relative, 'closing/') => self::CeremonyDirectories['closing'].'/'.$basename,
            ...
            $relative === 'counting/sealed' => self::CeremonyDirectories['voting'].'/sealed-ballot-box',
            str_starts_with($relative, 'counting/sealed/') => self::CeremonyDirectories['voting'].'/sealed-ballot-box/'.$basename,
            ...
            $relative === 'operational-observations' => self::CeremonyDirectories['audit'].'/operational-observations',
            ...
            $relative === 'usability-simulations' => self::CeremonyDirectories['audit'].'/usability-simulations',
            str_starts_with($relative, 'usability-simulations/') => self::CeremonyDirectories['audit'].'/usability-simulations/'.$basename,
