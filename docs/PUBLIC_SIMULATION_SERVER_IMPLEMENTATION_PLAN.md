...
10. Add concurrent multi-precinct scenarios, browser tests, retention policy, and Review Kit. Next: controlled retention-review reporting and the offline COMELEC Review Kit.
